...
myApple.moveDirection(TurtleDirection.Backwards, 25)
```
...
myApple.moveDirection(TurtleDirection.Backwards, 30)
...
myApple.moveDirection(TurtleDirection.Backwards, 15)
```
```
